...
<p>
    <em>Esto es una clase que cree yo, si no la usaron nunca recomiendo no usarla, tiene sus cosas.</em>
</p>


<em>Adentro de la carpeta de test agregar un package llamado helper, agregar una clase llamada RandomDataForObject y copiar y pegar esto, reemplazar el package en caso de ser necesario.</em>
```java
